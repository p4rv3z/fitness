	<div id="fh5co-wrapper">
		...
		<div class="fh5co-hero">
			...
			<div class="fh5co-cover" data-stellar-background-ratio="0.5" style="background-image: url(assets/front_end_assets/images/home-image.jpg);">
				<div class="desc animate-box">
					<div class="container">
						<div class="row">
							<div class="col-md-7">
								<h2>Fitness &amp; Health <br>is a <b>Mentality.</b></h2>
								<p><span>Provides<i class="icon-heart3"></i>quality equipments, trainers, facilities and guidelines to make your body strong, fit and healthy.<a href="#" class="fh5co-site-name">Best Choice For you.</a></span></p>
				...
				<div class="row">
					<div class="col-md-8 col-md-offset-2">
						<div class="heading-section text-center animate-box">
							...
							<p>We have thousands of members with a long time experience in providing quality heath care service.</p>
						</div>
					</div>
				</div>
				...
				<div class="row">
					<div class="col-md-8 col-md-offset-2 col-sm-12 col-sm-offset-0 col-xs-12 col-xs-offset-0 text-center fh5co-table">
						<div class="fh5co-intro fh5co-table-cell animate-box">
							...
							<p>Made with love by the fine  at <a href="http://freehtml5.co">Fitness.</a></p>
						</div>
					</div>
				</div>
			</div>
		...
		<div id="fh5co-team-section" class="fh5co-lightgray-section">
			<div class="container">
				...
				<div class="row text-center">
					<div class="col-md-4 col-sm-6">
						<div class="team-section-grid animate-box" style="background-image: url(assets/front_end_assets/images/trainer-1.jpg);">
					...
					<div class="col-md-4 col-sm-6">
						<div class="team-section-grid animate-box" style="background-image: url(assets/front_end_assets/images/trainer-2.jpg);">
							<div class="overlay-section">
								<div class="desc">
									<h3>James Smith</h3>
					...
					<div class="col-md-4 col-sm-6">
						<div class="team-section-grid animate-box" style="background-image: url(assets/front_end_assets/images/trainer-3.jpg);">
							<div class="overlay-section">
								<div class="desc">
									<h3>John Doe</h3>
					...
					<div class="col-md-4 col-sm-6">
						<div class="team-section-grid animate-box" style="background-image: url(assets/front_end_assets/images/trainer-4.jpg);">
							<div class="overlay-section">
								<div class="desc">
									<h3>John Doe</h3>
									<span>Chief Executive Officer</span>
					...
					<div class="col-md-4 col-sm-6">
						<div class="team-section-grid animate-box" style="background-image: url(assets/front_end_assets/images/trainer-5.jpg);">
							<div class="overlay-section">
								<div class="desc">
									<h3>John Doe</h3>
									<span>Chief Executive Officer</span>
					...
					<div class="col-md-4 col-sm-6">
						<div class="team-section-grid animate-box" style="background-image: url(assets/front_end_assets/images/trainer-6.jpg);">
							<div class="overlay-section">
								<div class="desc">
									<h3>John Doe</h3>
									<span>Chief Executive Officer</span>
		...
		<div class="fh5co-parallax" style="background-image: url(assets/front_end_assets/images/home-image-2.jpg);" data-stellar-background-ratio="0.5">
			<div class="overlay"></div>
			<div class="container">
				<div class="row">
						...
						<div class="col-md-12 col-md-offset-0">
							<div class="fh5co-blog animate-box">
								<div class="inner-post">
									<a href="#"><img class="img-responsive" src="assets/front_end_assets/images/blog-1.jpg" alt=""></a>
								</div>
								<div class="desc">
